...
import 'package:ppay_mobile/screens/views/features_subscreen/data_success_screen.dart';
import 'package:ppay_mobile/screens/widgets/colors.dart';
import 'package:ppay_mobile/screens/widgets/pin_custom_keyboard.dart';

class DataPinBottomsheet extends StatefulWidget {
  const DataPinBottomsheet({super.key});

  @override
  State<DataPinBottomsheet> createState() => _DataPinBottomsheetState();
}

class _DataPinBottomsheetState extends State<DataPinBottomsheet> {
  ...
  void _onKeyTap(String value) {
    ...
    if (_realPin.length == 4) {
      Future.delayed(const Duration(milliseconds: 200), () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const DataSuccessScreen()),
        );
      });
    }
  }
