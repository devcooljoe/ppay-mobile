...
import 'package:ppay_mobile/screens/views/features_subscreen/flight_paymwnt_success_screen.dart';
import 'package:ppay_mobile/screens/widgets/colors.dart';
import 'package:ppay_mobile/screens/widgets/pin_custom_keyboard.dart';

class FlightPinBottomsheet extends StatefulWidget {
  const FlightPinBottomsheet({super.key});

  @override
  State<FlightPinBottomsheet> createState() => _FlightPinBottomsheetState();
}

class _FlightPinBottomsheetState extends State<FlightPinBottomsheet> {
  ...
  void _onKeyTap(String value) {
    ...
    if (_realPin.length == 4) {
      Future.delayed(const Duration(milliseconds: 200), () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const FlightPaymwntSuccessScreen()),
        );
      });
    }
  }
