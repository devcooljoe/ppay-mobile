...
import 'package:ppay_mobile/screens/views/features_subscreen/passenger_details_two_screen.dart';
import 'package:ppay_mobile/screens/widgets/colors.dart';
import 'package:ppay_mobile/screens/widgets/flight_policies_bottomsheet.dart';
import 'package:ppay_mobile/screens/widgets/touch_opacity.dart';

class FlightDetailsTwoScreen extends StatefulWidget {
  const FlightDetailsTwoScreen({super.key});

  @override
  State<FlightDetailsTwoScreen> createState() => _FlightDetailsTwoScreenState();
}

class _FlightDetailsTwoScreenState extends State<FlightDetailsTwoScreen> {
  @override
                  ...
                  TouchOpacity(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => PassengerDetailsTwoScreen(),
                        ),
                      );
                    },
                    child: Container(
