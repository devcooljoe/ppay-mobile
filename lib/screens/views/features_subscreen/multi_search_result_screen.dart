...
import 'package:ppay_mobile/screens/views/features_subscreen/multi_flight_details_screen.dart';
...
class MultiSearchResultScreen extends StatefulWidget {
  const MultiSearchResultScreen({super.key});

  @override
  State<MultiSearchResultScreen> createState() =>
      _MultiSearchResultScreenState();
}

class _MultiSearchResultScreenState extends State<MultiSearchResultScreen> {
  @override
                    ...
                    TouchOpacity(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MultiFlightDetailsScreen(),
                          ),
                        );
                      },
                      child: Container(
