...
class GiftcardSellReceiptScreen extends StatefulWidget {
  const GiftcardSellReceiptScreen({super.key});

  @override
  State<GiftcardSellReceiptScreen> createState() =>
      _GiftcardSellReceiptScreenState();
}

class _GiftcardSellReceiptScreenState extends State<GiftcardSellReceiptScreen> {
  @override
