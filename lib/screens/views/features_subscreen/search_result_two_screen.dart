...
import 'package:ppay_mobile/screens/views/features_subscreen/flight_details_two_Screen.dart';
...
class SearchResultTwoScreen extends StatefulWidget {
  const SearchResultTwoScreen({super.key});

  @override
  State<SearchResultTwoScreen> createState() => _SearchResultTwoScreenState();
}

class _SearchResultTwoScreenState extends State<SearchResultTwoScreen> {
  @override
                    ...
                    TouchOpacity(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => FlightDetailsTwoScreen(),
                          ),
                        );
                      },
                      child: Container(
