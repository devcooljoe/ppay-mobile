...
import 'package:ppay_mobile/screens/views/features_subscreen/multi_passengers_details_screen.dart';
import 'package:ppay_mobile/screens/widgets/colors.dart';
import 'package:ppay_mobile/screens/widgets/flight_policies_bottomsheet.dart';
import 'package:ppay_mobile/screens/widgets/touch_opacity.dart';

class MultiFlightDetailsScreen extends StatefulWidget {
  const MultiFlightDetailsScreen({super.key});

  @override
  State<MultiFlightDetailsScreen> createState() =>
      _MultiFlightDetailsScreenState();
}

class _MultiFlightDetailsScreenState extends State<MultiFlightDetailsScreen> {
  @override
                  ...
                  TouchOpacity(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MultiPassengersDetailsScreen(),
                        ),
                      );
                    },
                    child: Container(
