...
import 'package:ppay_mobile/screens/views/login_password_changed_screen.dart';
import 'package:ppay_mobile/screens/widgets/colors.dart';
import 'package:ppay_mobile/screens/widgets/textfield.dart';

class LoginPasswordResetScreen extends StatefulWidget {
  const LoginPasswordResetScreen({super.key});

  @override
  State<LoginPasswordResetScreen> createState() =>
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => LoginPasswordChangedScreen(),
                      ),
                    );
                  },
                  child: Text(
