...
@RoutePage()
class CryptoTransactionsDetailPage extends StatefulWidget {
  const CryptoTransactionsDetailPage({super.key});

  @override
  State<CryptoTransactionsDetailPage> createState() =>
      _CryptoTransactionsDetailPageState();
}

class _CryptoTransactionsDetailPageState
    extends State<CryptoTransactionsDetailPage> {
  @override
