...
@RoutePage()
class MultiPaymentSuccessPage extends StatefulWidget {
  const MultiPaymentSuccessPage({super.key});

  @override
  State<MultiPaymentSuccessPage> createState() =>
      _MultiPaymentSuccessPageState();
}

class _MultiPaymentSuccessPageState extends State<MultiPaymentSuccessPage> {
  @override
