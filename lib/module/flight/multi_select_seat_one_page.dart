...
@RoutePage()
class MultiSelectSeatOnePage extends StatefulWidget {
  const MultiSelectSeatOnePage({super.key});

  @override
  State<MultiSelectSeatOnePage> createState() => _MultiSelectSeatOnePageState();
}

class _MultiSelectSeatOnePageState extends State<MultiSelectSeatOnePage> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: TouchOpacity(
                onTap: () {
                  context.router.push(MultiSelectSeatTwoRoute());
                },
                child: Container(
                  height: 46.h,
                  width: double.infinity,
