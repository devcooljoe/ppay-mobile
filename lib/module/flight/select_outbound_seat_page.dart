...
@RoutePage()
class SelectOutboundSeatPage extends StatefulWidget {
  const SelectOutboundSeatPage({super.key});

  @override
  State<SelectOutboundSeatPage> createState() =>
      _SelectOutboundSeatPageState();
}

class _SelectOutboundSeatPageState extends State<SelectOutboundSeatPage> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: TouchOpacity(
                onTap: () {
                  context.router.push(SelectInboundSeatRoute());
                },
                child: Container(
                  height: 46.h,
                  width: double.infinity,
