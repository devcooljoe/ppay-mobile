...
import 'package:ppay_mobile/shared/widgets/flight_two_pin_bottomsheet.dart';
import 'package:ppay_mobile/shared/widgets/colors.dart';
import 'package:ppay_mobile/shared/widgets/option_picker.dart';
import 'package:ppay_mobile/shared/widgets/touch_opacity.dart';

@RoutePage()
class FlightTwoPaymentPage extends StatefulWidget {
  const FlightTwoPaymentPage({super.key});

  @override
  State<FlightTwoPaymentPage> createState() => _FlightTwoPaymentPageState();
}

class _FlightTwoPaymentPageState extends State<FlightTwoPaymentPage> {
  int selectedIndex = 0;
  @override
