...
@RoutePage()
class FlightPaymentReceiptPage extends StatefulWidget {
  const FlightPaymentReceiptPage({super.key});

  @override
  State<FlightPaymentReceiptPage> createState() =>
      _FlightPaymentReceiptPageState();
}

class _FlightPaymentReceiptPageState
    extends State<FlightPaymentReceiptPage> {
  @override
