...
@RoutePage()
class MultiSearchResultPage extends StatefulWidget {
  const MultiSearchResultPage({super.key});

  @override
  State<MultiSearchResultPage> createState() => _MultiSearchResultPageState();
}

class _MultiSearchResultPageState extends State<MultiSearchResultPage> {
  @override
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TouchOpacity(
                      onTap: () {
                        context.router.push(MultiFlightDetailsRoute());
                      },
                      child: Container(
                        height: 46.h,
                        width: double.infinity,
