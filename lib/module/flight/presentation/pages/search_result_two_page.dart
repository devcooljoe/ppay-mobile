...
@RoutePage()
class SearchResultTwoPage extends HookConsumerWidget {
  const SearchResultTwoPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: PPaymobileColors.mainScreenBackground,
        centerTitle: true,
        title: Text('Search Result', style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 18.sp, fontWeight: FontWeight.w500)),
        leading: Padding(
        ...
        child: searchAsync.when(
          loading: () => ListView(
            ...
            children: List.generate(3, (_) => Padding(
              ...
              child: SkeletonLoader(width: double.infinity, height: 260.h, borderRadius: BorderRadius.circular(12.r)),
            )),
          ),
          error: (e, _) => Center(
            child: Padding(
          ...
          data: (flights) {
            if (flights == null || flights.isEmpty) {
              return EmptyState(imagePath: 'assets/images/flight_ticket.png', message: 'No round-trip flights found');
            }
            return ListView(
              children: [
                38.verticalSpace,
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              if (searchState.returnDate != null && searchState.returnDate!.isNotEmpty) ...[
                                ...
                                8.horizontalSpace,
                                Text(FlightFormatUtils.formatDate(searchState.returnDate!), style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 14.sp, fontWeight: FontWeight.w400)),
                              ],
                            ]),
                          ],
                        ),
                ...
                Padding(
                  ...
                  child: Text('Found ${flights.length} available at best price', style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 12.sp, fontWeight: FontWeight.w500)),
                ),
                16.verticalSpace,
                ...flights.map((flight) => Padding(
                  padding: EdgeInsets.only(left: 20.w, right: 20.w, bottom: 16.h),
                  child: _RoundTripFlightCard(flight: flight),
                )),
                20.verticalSpace,
              ],
            );
...
class _RoundTripFlightCard extends ConsumerWidget {
  final FlightEntity flight;
  const _RoundTripFlightCard({required this.flight});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Widget _segmentRow(FlightSegmentEntity seg, String label) => Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(seg.airportFrom, style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 20.sp, fontWeight: FontWeight.w500)),
                4.verticalSpace,
                Text(FlightFormatUtils.formatTime(seg.departureTime), style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 12.sp, fontWeight: FontWeight.w500)),
              ],
            ),
            Row(children: [
              SizedBox(height: 13.h, width: 13.h, child: SvgPicture.asset('assets/icon/spacer.svg', fit: BoxFit.contain)),
              5.horizontalSpace,
              SizedBox(height: 2.h, width: 55.w, child: SvgPicture.asset('assets/icon/dashed_1.svg', fit: BoxFit.contain)),
            ]),
            Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                ...
                6.verticalSpace,
                Text(label, style: TextStyle(fontFamily: 'InstrumentSans', color: PPaymobileColors.buttonColor, fontSize: 12.sp, fontWeight: FontWeight.w500)),
              ],
            ),
            Row(children: [
              SizedBox(height: 2.h, width: 55.w, child: SvgPicture.asset('assets/icon/dashed_2.svg', fit: BoxFit.contain)),
              5.horizontalSpace,
            ...
            Column(
              ...
              children: [
                Text(seg.airportTo, style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 20.sp, fontWeight: FontWeight.w500)),
                4.verticalSpace,
                Text(FlightFormatUtils.formatTime(seg.arrivalTime), style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 12.sp, fontWeight: FontWeight.w500)),
              ],
            ),
          ],
        ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text('Round Trip', style: TextStyle(fontFamily: 'InstrumentSans', color: PPaymobileColors.navContainerbgColor, fontSize: 12.sp, fontWeight: FontWeight.w500)),
              ),
            ],
          ),
          17.verticalSpace,
          _segmentRow(outbound, 'Outbound'),
          if (inbound != null) ...[
            12.verticalSpace,
            _segmentRow(inbound, 'Return'),
          ],
          16.verticalSpace,
          ...
          TouchOpacity(
            onTap: () {
              ...
              context.router.push(const FlightDetailsTwoRoute());
            },
            child: Container(
