...
@RoutePage()
class MultiPassengersDetailsPage extends StatefulWidget {
  const MultiPassengersDetailsPage({super.key});

  @override
  State<MultiPassengersDetailsPage> createState() =>
      _MultiPassengersDetailsPageState();
}

class _MultiPassengersDetailsPageState
    extends State<MultiPassengersDetailsPage> {
  @override
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              TouchOpacity(
                onTap: () {
                  context.router.push(MultiSelectSeatOneRoute());
                },
                child: Container(
                  height: 46.h,
                  width: 212.w,
