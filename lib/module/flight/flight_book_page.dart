...
@RoutePage()
class FlightBookPage extends StatefulWidget {
  const FlightBookPage({super.key});

  @override
  State<FlightBookPage> createState() => _FlightBookPageState();
}

class _FlightBookPageState extends State<FlightBookPage> {
