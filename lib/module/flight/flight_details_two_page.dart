...
@RoutePage()
class FlightDetailsTwoPage extends StatefulWidget {
  const FlightDetailsTwoPage({super.key});

  @override
  State<FlightDetailsTwoPage> createState() => _FlightDetailsTwoPageState();
}

class _FlightDetailsTwoPageState extends State<FlightDetailsTwoPage> {
  @override
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TouchOpacity(
                    onTap: () {
                      context.router.push(PassengerDetailsTwoRoute());
                    },
                    child: Container(
                      height: 46.h,
                      width: 212.w,
