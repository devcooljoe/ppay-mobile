...
@RoutePage()
class SelectInboundSeatPage extends StatefulWidget {
  const SelectInboundSeatPage({super.key});

  @override
  State<SelectInboundSeatPage> createState() =>
      _SelectInboundSeatPageState();
}

class _SelectInboundSeatPageState extends State<SelectInboundSeatPage> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: TouchOpacity(
                onTap: () {
                  context.router.push(FlightTwoPaymentRoute());
                },
                child: Container(
                  height: 46.h,
                  width: double.infinity,
