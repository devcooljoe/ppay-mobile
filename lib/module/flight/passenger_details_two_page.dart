...
@RoutePage()
class PassengerDetailsTwoPage extends StatefulWidget {
  const PassengerDetailsTwoPage({super.key});

  @override
  State<PassengerDetailsTwoPage> createState() =>
      _PassengerDetailsTwoPageState();
}

class _PassengerDetailsTwoPageState extends State<PassengerDetailsTwoPage> {
  @override
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              TouchOpacity(
                onTap: () {
                  context.router.push(SelectOutboundSeatRoute());
                },
                child: Container(
                  height: 46.h,
                  width: 212.w,
