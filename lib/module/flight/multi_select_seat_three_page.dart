...
@RoutePage()
class MultiSelectSeatThreePage extends StatefulWidget {
  const MultiSelectSeatThreePage({super.key});

  @override
  State<MultiSelectSeatThreePage> createState() =>
      _MultiSelectSeatThreePageState();
}

class _MultiSelectSeatThreePageState extends State<MultiSelectSeatThreePage> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: TouchOpacity(
                onTap: () {
                  context.router.push(MultiPaymentRoute());
                },
                child: Container(
                  height: 46.h,
                  width: double.infinity,
