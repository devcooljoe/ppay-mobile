...
@RoutePage()
class FlightTwoPaymentSuccessPage extends StatefulWidget {
  const FlightTwoPaymentSuccessPage({super.key});

  @override
  State<FlightTwoPaymentSuccessPage> createState() =>
      _FlightTwoPaymentSuccessPageState();
}

class _FlightTwoPaymentSuccessPageState
    extends State<FlightTwoPaymentSuccessPage> {
  @override
        ...
        child: Padding(
          ...
          child: ListView(
            children: [
              ...
              TouchOpacity(
                onTap: () {
                  context.router.push(FlightTwoPaymentReceiptRoute());
                },
                child: Container(
                  height: 46.h,
