...
@RoutePage()
class MultiFlightDetailsPage extends StatefulWidget {
  const MultiFlightDetailsPage({super.key});

  @override
  State<MultiFlightDetailsPage> createState() => _MultiFlightDetailsPageState();
}

class _MultiFlightDetailsPageState extends State<MultiFlightDetailsPage> {
  @override
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TouchOpacity(
                    onTap: () {
                      context.router.push(MultiPassengersDetailsRoute());
                    },
                    child: Container(
                      height: 46.h,
                      width: 212.w,
