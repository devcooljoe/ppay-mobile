...
import 'package:ppay_mobile/module/flight/multi_payment_receipt_screen.dart';
import 'package:ppay_mobile/shared/widgets/colors.dart';
import 'package:ppay_mobile/shared/widgets/touch_opacity.dart';

class MultiPaymentSuccessScreen extends StatefulWidget {
  const MultiPaymentSuccessScreen({super.key});

  @override
  State<MultiPaymentSuccessScreen> createState() =>
      _MultiPaymentSuccessScreenState();
}

class _MultiPaymentSuccessScreenState extends State<MultiPaymentSuccessScreen> {
  @override
              ...
              TouchOpacity(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => MultiPaymentReceiptScreen(),
                    ),
                  );
                },
                child: Container(
