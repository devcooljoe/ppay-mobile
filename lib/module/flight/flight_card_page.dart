...
@RoutePage()
class FlightCardPage extends StatefulWidget {
  const FlightCardPage({super.key});

  @override
  State<FlightCardPage> createState() => _FlightCardPageState();
}

class _FlightCardPageState extends State<FlightCardPage> {
  @override
