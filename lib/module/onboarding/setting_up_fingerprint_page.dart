...
@RoutePage()
class SettingUpFingerprintPage extends StatefulWidget {
  const SettingUpFingerprintPage({super.key});

  @override
  State<SettingUpFingerprintPage> createState() =>
      _SettingUpFingerprintPageState();
}

class _SettingUpFingerprintPageState
    extends State<SettingUpFingerprintPage> {
  @override
                  ...
                  TouchOpacity(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          context.router.push(FingerprintCompleteRoute());
                        },
                        child: Row(
