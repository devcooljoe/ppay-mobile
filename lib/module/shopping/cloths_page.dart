...
import 'package:ppay_mobile/module/shopping/cloths_details_page.dart';
import 'package:ppay_mobile/module/crypto/watchlist_page.dart';
                  ...
                  TouchOpacity(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ClothsDetailsPage(),
                        ),
