...
@RoutePage()
class BettingSuccessPage extends StatefulWidget {
  const BettingSuccessPage({super.key});

  @override
  State<BettingSuccessPage> createState() => _BettingSuccessPageState();
}

class _BettingSuccessPageState extends State<BettingSuccessPage> {
  @override
