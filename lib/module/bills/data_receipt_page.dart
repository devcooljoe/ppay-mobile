...
@RoutePage()
class DataReceiptPage extends StatefulWidget {
  const DataReceiptPage({super.key});

  @override
  State<DataReceiptPage> createState() => _DataReceiptPageState();
}

class _DataReceiptPageState extends State<DataReceiptPage> {
  @override
