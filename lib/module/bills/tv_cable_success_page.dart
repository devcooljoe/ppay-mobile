...
@RoutePage()
class TvCableSuccessPage extends StatefulWidget {
  const TvCableSuccessPage({super.key});

  @override
  State<TvCableSuccessPage> createState() => _TvCableSuccessPageState();
}

class _TvCableSuccessPageState extends State<TvCableSuccessPage> {
  @override
