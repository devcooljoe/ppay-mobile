...
@RoutePage()
class ElectricityReceiptPage extends StatefulWidget {
  const ElectricityReceiptPage({super.key});

  @override
  State<ElectricityReceiptPage> createState() =>
      _ElectricityReceiptPageState();
}

class _ElectricityReceiptPageState extends State<ElectricityReceiptPage> {
  @override
