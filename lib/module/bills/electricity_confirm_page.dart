...
@RoutePage()
class ElectricityConfirmPage extends StatefulWidget {
  const ElectricityConfirmPage({super.key});

  @override
  State<ElectricityConfirmPage> createState() =>
      _ElectricityConfirmPageState();
}

class _ElectricityConfirmPageState extends State<ElectricityConfirmPage> {
  @override
