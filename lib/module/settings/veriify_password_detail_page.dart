...
@RoutePage()
class VeriifyPasswordDetailPage extends StatefulWidget {
  const VeriifyPasswordDetailPage({super.key});

  @override
  State<VeriifyPasswordDetailPage> createState() =>
      _VeriifyPasswordDetailPageState();
}

class _VeriifyPasswordDetailPageState
    extends State<VeriifyPasswordDetailPage> {
  @override
