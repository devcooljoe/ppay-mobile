...
@RoutePage()
class VerifyForgotPage extends StatefulWidget {
  const VerifyForgotPage({super.key});

  @override
  State<VerifyForgotPage> createState() => _VerifyforgotPageState();
}

class _VerifyforgotPageState extends State<VerifyForgotPage> {
  @override
