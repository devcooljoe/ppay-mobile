...
abstract class $ResetPasswordRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String resetToken, String password, String confirmPassword});
}
...
class _$ResetPasswordRequestImpl implements _ResetPasswordRequest {
  ...
  @override
  String toString() {
    return 'ResetPasswordRequest(resetToken: $resetToken, password: $password, confirmPassword: $confirmPassword)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, resetToken, password, confirmPassword);
