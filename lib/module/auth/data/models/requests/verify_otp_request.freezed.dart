...
class _$VerifyOtpRequestImpl implements _VerifyOtpRequest {
  const _$VerifyOtpRequestImpl({required this.otpCode});
  ...
  @override
  String toString() {
    return 'VerifyOtpRequest(otpCode: $otpCode)';
  }
...
abstract class _VerifyOtpRequest implements VerifyOtpRequest {
  const factory _VerifyOtpRequest({required final String otpCode}) =
