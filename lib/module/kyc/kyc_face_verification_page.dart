...
@RoutePage()
class KycFaceVerificationPage extends StatefulWidget {
  const KycFaceVerificationPage({super.key});

  @override
  State<KycFaceVerificationPage> createState() =>
      _KycFaceVerificationPageState();
}

class _KycFaceVerificationPageState extends State<KycFaceVerificationPage> {
  @override
