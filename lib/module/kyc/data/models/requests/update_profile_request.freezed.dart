...
abstract class $UpdateProfileRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? fullName, String? dob});
}
...
class _$UpdateProfileRequestImpl implements _UpdateProfileRequest {
  const _$UpdateProfileRequestImpl({this.fullName, this.dob});
  ...
  @override
  String toString() {
    return 'UpdateProfileRequest(fullName: $fullName, dob: $dob)';
  }
...
abstract class _UpdateProfileRequest implements UpdateProfileRequest {
  const factory _UpdateProfileRequest(
      {final String? fullName, final String? dob}) = _$UpdateProfileRequestImpl;
