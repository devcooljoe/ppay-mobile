...
abstract class WalletRemoteDataSource {
  ...
  Future<PaginatedTransactionsModel> getMyTransactions(int pageNumber, int pageSize);
  Future<double> calculateFee({required String transactionType, required double amount});
}
