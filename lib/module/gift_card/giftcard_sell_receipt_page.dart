...
@RoutePage()
class GiftcardSellReceiptPage extends StatefulWidget {
  const GiftcardSellReceiptPage({super.key});

  @override
  State<GiftcardSellReceiptPage> createState() =>
      _GiftcardSellReceiptPageState();
}

class _GiftcardSellReceiptPageState extends State<GiftcardSellReceiptPage> {
  @override
