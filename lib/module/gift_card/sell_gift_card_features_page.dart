...
@RoutePage()
class SellGiftCardFeaturesPage extends StatefulWidget {
  const SellGiftCardFeaturesPage({super.key});

  @override
  State<SellGiftCardFeaturesPage> createState() =>
      _SellGiftCardFeaturesPageState();
}

class _SellGiftCardFeaturesPageState
    extends State<SellGiftCardFeaturesPage> {
  @override
