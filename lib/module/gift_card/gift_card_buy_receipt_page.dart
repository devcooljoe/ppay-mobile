...
@RoutePage()
class GiftCardBuyReceiptPage extends StatefulWidget {
  const GiftCardBuyReceiptPage({super.key});

  @override
  State<GiftCardBuyReceiptPage> createState() =>
      _GiftCardBuyReceiptPageState();
}

class _GiftCardBuyReceiptPageState extends State<GiftCardBuyReceiptPage> {
  @override
