  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leadingWidth: 56.w,
        centerTitle: true,
        title: Text('Card Transaction', style: TextStyle(fontFamily: 'InstrumentSans', color: Colors.black, fontSize: 18.sp, fontWeight: FontWeight.w500)),
        leading: Padding(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            6.verticalSpace,
                                            Text(formatTime(tx.createdAt), style: TextStyle(fontFamily: 'Gilroy', color: PPaymobileColors.svgIconColor, fontSize: 12.sp, fontWeight: FontWeight.w500)),
                                          ],
                                        ),
                                      ],
                                    ),
