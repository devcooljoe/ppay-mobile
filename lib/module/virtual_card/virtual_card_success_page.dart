...
@RoutePage()
class VirtualCardSuccessPage extends StatefulWidget {
  const VirtualCardSuccessPage({super.key});

  @override
  State<VirtualCardSuccessPage> createState() =>
      _VirtualCardSuccessPageState();
}

class _VirtualCardSuccessPageState extends State<VirtualCardSuccessPage> {
  @override
