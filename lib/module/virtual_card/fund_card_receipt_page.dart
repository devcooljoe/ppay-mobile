...
@RoutePage()
class FundCardReceiptPage extends StatefulWidget {
  const FundCardReceiptPage({super.key});

  @override
  State<FundCardReceiptPage> createState() => _FundCardReceiptPageState();
}

class _FundCardReceiptPageState extends State<FundCardReceiptPage> {
  @override
